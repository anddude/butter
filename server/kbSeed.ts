...
export const kbSeed: KbEntry[] = [
  ...
  // The information below contains pertinent details about 20 advertising campaign projects,
  // important details about the company history, company-wide initiatives, and their clients.

  // ----------  client workstyle profiles  ----------

  {
    id: "kb-client-firebird-workstyle",
    title: "FireBird Tacos — Communication & Decision Style",
    text: `
FireBird Tacos communication is direct and execution-focused.

Key interpretation notes:
- Requests usually imply near-term action unless otherwise stated.
- Performance metrics are tied closely to decision-making.
- Creative discussions are expected to link directly to sales or traffic impact.
- Field marketing and franchise constraints are often implicit and not restated.
  `.trim(),
    tags: [
      "type:client-profile",
      "client:FireBird-Tacos",
      "campaign:Ember",
      "intent:email-interpretation"
    ],
  },
  {
    id: "kb-client-novatek-workstyle",
    title: "Novatek Consumer Electronics — Communication & Work Style",
    text: `
Novatek stakeholders communicate in a relationship-forward tone and often include personal context before work topics.

Key interpretation notes:
- Work requests are usually embedded mid-email, not stated upfront.
- Budget-related messages are typically early alignment signals, not final approvals.
- Novatek prefers confirmation and data-backed reassurance before proceeding.
- Urgency is explicitly stated when present; absence of urgency implies flexibility.
- Small talk should be ignored when identifying actionable items.
  `.trim(),
    tags: [
      "type:client-profile",
      "client:Novatek",
...

  {
    ...
    text: `Client: Novatek Consumer Electronics (legacy brand; retail + DTC).
...
Target: lift unaided awareness +8 pts in Q2 tracker and increase DTC conversion rate from 2.1% to 2.6% during launch window.
...
Next steps: finalize scripts (Jan 29), casting (Feb 2), first edit review (Feb 16).`,
  ...
  },
  {
    ...
    text: `Client: CloudFleet (B2B SaaS; workflow automation for mid-market ops teams).
...
Mitigation: focus on high-intent search + retargeting; problem-first creative angle; gated webinar to accelerate nurture.`,
  ...
  },
  {
    ...
    text: `Client: BrightSteps Foundation (national nonprofit; youth education + mentorship).
...
Status: proposal under review by board finance committee; final decision expected Feb 12.`,
  ...
  },
  {
    ...
    text: `Client: FireBird Tacos (national QSR; 520 locations).
...
Mitigation: weekly inventory check-in; simplified store kit; contingency creative for limited availability messaging.`,
  ...
  },
  {
    ...
    text: `Client: PineBank Mobile (consumer fintech; checking + credit builder).
...
Mitigation: claim hierarchy (hard claims vs soft claims); early legal workshops; backup creative using softer language without performance claims.`,
  ...
  },
  {
    ...
    text: `Client: HarborWell Health (regional healthcare provider; three-state footprint).
...
Project start date: August 22, 2022. Project inactive date: January 5, 2023.
...
Post-project note: Aurora Creative retained as an approved vendor for future discrete creative projects.`,
  ...
  },
  {
    ...
    text: `Client: LoopSound (music streaming; freemium subscription).
...
Mitigation: messaging emphasizes popular picks for your vibe (non-specific) and includes preference controls.`,
  ...
  },
  {
    ...
    text: `Client: Ridge & Harbor Realty Group (national; residential + commercial).
...
Mitigation: market-by-market rollout plan + minimum viable brand compliance checklist.`,
  ...
  },
  {
    ...
    text: `Client: Meridian Systems (enterprise IT + services; Fortune 500).
...
Project start date: January 9, 2023. Project inactive date: September 15, 2023.
...
Outcome: time-to-hire reduced 18%; applicants per posting +27%; strongest lift came from employee authenticity and clear benefits messaging.
...
Post-project note: engagement concluded on positive terms; client remains a referral source and past-case-study reference.`,
  ...
  },
  {
    ...
    text: `Client: Asteria Voyages (luxury travel; relaunch after ownership change).
...
Mitigation: backup indoor set day; parallel edit team; pre-approved music library options.`,
  ...
  },
  {
    ...
    text: `Client: ParcelPilot (Series B; last-mile logistics app for SMBs).
...
Status: proposal in negotiation; awaiting contract and access to analytics + ad accounts.`,
  ...
  },
  {
    ...
    text: `Client: HelioGrid Energy (multinational; energy transition + infrastructure).
...
Mitigation: precise language, third-party citations within owned content, and scenario planning.`,
  ...
  },
  {
    ...
    text: `Client: Vanta Motors (automotive; EV line expansion).
...
Post-campaign note: range anxiety creative addressed objections most effectively.`,
  ...
  },
  {
    ...
    text: `Client: Juniper & Main (fashion; DTC; seasonal collabs).
...
Mitigation: transparent inventory messaging, staggered restock plan, and a second-chance waitlist.`,
  ...
  },
  {
    ...
    text: `Client: ClearShield Insurance (personal lines; renters + auto).
...
Mitigation: pre-approved wording modules and early legal involvement.`,
  ...
  },
  {
    ...
    text: `Client: Coastline Tourism Board (regional tourism authority).
...
Project start date: February 14, 2022. Project inactive date: October 31, 2022.
...
Outcome: visitation recovered to 95% of baseline within one season; off-season bookings increased by 11%.
...
Post-project note: work remains a flagship case study for tourism and recovery-focused campaigns.`,
  ...
  },
  {
    ...
    text: `Client: TaskMint (consumer productivity app; subscription).
...
Mitigation: messaging focuses on first-win outcomes and transparent setup time.`,
  ...
  },
  {
    ...
    text: `Client: BlueCrest Beverages (CPG; sparkling water).
...
Mitigation: modular asset system and pre-built size variants.`,
  ...
  },
  {
    ...
    text: `Client: LearnLoop EDU (edtech; parent-facing subscription).
...
Mitigation: careful language, real parent stories, and clear explanation of methodology.`,
  ...
  },
  {
    ...
    text: `Client: QuartzWorks (enterprise analytics; annual user conference).
...
Mitigation: modular agenda blocks and rapid-turn design templates.`,
...

  {
    ...
    text: `Internal owner: People Operations (Aurora Creative).
...
Success metrics: +15% improvement in review fairness on engagement survey and ≥ 90% on-time completion rate in first cycle.`,
  ...
  },
  {
    ...
    text: `Owner: Operations Team (Aurora Creative).
...
Note: travel approvals and room bookings tracked separately in Ops ticketing.`,
  ...
  },
  {
    ...
    text: `Owner: People Operations + Legal (Aurora Creative).
...
Scope: summarizes core benefits and high-level policies for full-time employees unless otherwise specified.
...
Where to find updates: the People Portal is the source of truth; handbook reviewed annually and updated as laws change.`,
  ...
  },
  {
    ...
    text: `Company overview: Aurora Creative is a mid-sized independent advertising agency founded in 2016 in New York City. The agency specializes in brand strategy, integrated campaigns, performance marketing, and content production for consumer, B2B, and regulated industries. Aurora Creative has intentionally remained small (50 employees) to prioritize senior-level involvement, cross-functional collaboration, and speed of execution.
Founding history: Aurora Creative was founded by Rina Kaur (CEO & Executive Creative Director) and Marcus Yen (Chief Communications Officer) after both previously held leadership roles at large global agency networks. The founding thesis was to build an agency that balanced high craft with operational discipline and transparent client partnerships. The company reached profitability in its second year and has grown steadily without outside investment.
...
Brand Strategy (8 employees): Laila Haddad (Strategy Director), Miles Okafor (Senior Strategist), Val Romero (Strategy Lead), Beth Kim (Senior Strategist), Felicia Stone (Content Strategy Director), Marcus Lee (Strategist), Jenna Morales (Associate Strategist), Aaron Feld (Associate Strategist).
Creative (12 employees): Rina Kaur (ECD, shared with leadership), Theo Grant (Creative Director), Elena Ortiz (Copy Director), Gia Romano (Content Director), Simone Duval (Senior Brand Designer), Nina Rowe (Art Director), Mira Das (Senior Social Creative), Arlo Bennett (Influencer Creative Lead), Heidi Lopes (UX Writer), Chris Molina (Senior Copywriter), Lena Fischer (Designer), Owen Price (Junior Copywriter).
Production (7 employees): Jonah Pierce (Executive Producer), Omar Singh (Creative Producer), Yumi Sato (Producer), Ian Wells (Video Producer), Rachel Bloom (Production Manager), Carlos Mendes (Post-Production Supervisor), Talia Rosen (Production Coordinator).
Media & Growth (9 employees): Evan Hale (Media Director), Jae Min (Performance Director), Janelle Price (Media Manager), Chris Yoon (Retail Media Lead), Lucas Reed (SEM Lead), Paige Novak (Media Strategist), Andre Moreau (Media Planner), Noor Iqbal (CRM Strategist), Ronan Blake (Product Analyst).
PR & Public Affairs (4 employees): Marcus Yen (CCO, shared), Max Feld (PR Lead), Harper Lin (Integrated Project Manager), Sasha Bell (Communications Designer).
Operations, HR, and Finance (6 employees): Selena Grant (shared), Marco Diaz (HR Business Partner), Keaton Shaw (shared), Nadia Imani (Legal Operations Manager), Hyo Park (Analytics & Finance Manager), Kira Bolton (Account Lead).
Organizational principles: Aurora Creative operates on small, senior-led pods with shared accountability across strategy, creative, media, and production. Titles reflect responsibility rather than tenure. Managers are expected to remain hands-on. Cross-department collaboration is required for all major campaigns.`,
    tags: [
      "type:internal",
  ...
  },
  {
    ...
    text: `This document summarizes Aurora Creative's key client companies, primary contacts, engagement history, and notable relationship context.
Novatek Consumer Electronics (current). Industry: consumer electronics. Contacts: Maya Chen (VP Brand), Ben Arroyo (Director, Global Media). Active work: Campaign Orbit. Context: risk-averse due to prior failed rebrand attempt (2019); requires data-backed recommendations.
CloudFleet (current). Industry: B2B SaaS. Contacts: Jordan Patel (CMO), Alina Ro (PMM Lead). Active work: Campaign Nimbus. Context: transitioning to product-led growth; expects rapid iteration and weekly performance readouts.
BrightSteps Foundation (proposed). Industry: nonprofit. Contacts: Renee Park (Executive Director), Malik Jones (Comms Manager). Active work: Campaign Halo (proposal). Context: board-governed; slow approvals; values mission alignment.
FireBird Tacos (current). Industry: QSR franchise. Contacts: Dana McKee (VP Marketing), Leo Kim (Field Marketing Lead). Active work: Campaign Ember. Context: franchise model creates execution variability; requires close coordination with field marketing.
PineBank Mobile (current). Industry: consumer fintech. Contacts: Sienna Brooks (Head of Brand), Victor Alvarez (Compliance Counsel). Active work: Campaign Vertex. Context: high-scrutiny regulatory environment; legal deeply embedded in creative process.
HarborWell Health (former, seasonal). Industry: healthcare. Contacts: Dr. Elise Morgan (Chief Patient Officer), Nate Vaughn (Marketing Ops). Past work: Campaign Lumen. Context: potential reactivation each fall.
LoopSound (current). Industry: music streaming. Contacts: Camila Reyes (Lifecycle Marketing), Devon Hart (Data Science). Active work: Campaign Pulse. Context: data-mature; strict privacy standards; quick to pause underperforming tactics.
Ridge & Harbor Realty Group (current). Industry: real estate. Contacts: Brooke Lin (Head of Marketing), Ethan Cole (Regional GM). Active work: Campaign Anchor. Context: semi-franchise structure; adoption and training as critical as creative quality.
Meridian Systems (former). Industry: enterprise IT. Contacts: Claire Donnelly (Talent Acquisition), Raj Mehta (Employer Brand). Past work: Campaign Strata. Context: strong referral source.
Asteria Voyages (current). Industry: luxury travel. Contacts: Celeste Wynn (CEO), Hugo Stein (Brand Director). Active work: Campaign Aurora. Context: founder-led; executive-level involvement required; decisions centralized with CEO.
ParcelPilot (proposed). Industry: logistics tech. Contacts: Ingrid Shaw (Head of Growth), Mateo Ruiz (Product). Active work: Campaign Catalyst (proposal). Context: fast-moving startup; success dependent on rapid testing.
HelioGrid Energy (current). Industry: energy and infrastructure. Contacts: Anya Volkov (Chief Communications Officer), Trent Ellis (Public Affairs). Active work: Campaign Northstar. Context: politically sensitive; requires disciplined language and scenario planning.`,
    tags: [
      "type:internal",
      "company:Aurora-Creative",
  ...
  },
  {
    ...
    text: `The Administrative Team at Aurora Creative is a cross-functional leadership and operations group responsible for governance, internal decision-making, and day-to-day business continuity.
Mandate: the team oversees agency-wide planning, budgeting, resourcing, hiring approvals, vendor relationships, policy enforcement, and risk management. Meets weekly to review operational health, active client risks, staffing capacity, and upcoming milestones.
Executive members:
Rina Kaur — CEO & Executive Creative Director. Provides overall company direction, final approval on major investments, senior client escalations, and creative arbitration when priorities conflict.
Marcus Yen — Chief Communications Officer. Advises on reputational risk, crisis preparedness, and executive communications for both Aurora Creative and select clients.
Selena Grant — Head of People. Owns hiring strategy, performance frameworks, compensation planning, benefits administration, and employee relations.
Operations members:
Keaton Shaw — Head of Operations. Leads financial planning, agency resourcing, vendor management, facilities, IT tooling, and internal process design.
...
Kira Bolton — Account Lead (Operations Liaison). Acts as bridge between client services and operations.
Decision authority: hiring approvals, budget reallocations over $50K, vendor selection, policy updates, and escalation resolution. Creative and strategy decisions remain department-led unless they introduce financial, legal, or reputational risk.
Operating cadence: weekly admin sync (60 min); monthly financial review with department heads; quarterly planning session.`,
    tags: [
      "type:internal",
      "company:Aurora-Creative",
  ...
  },
  {
    ...
    text: `This document summarizes current industry-wide trends in advertising and influential professionals shaping the market. Intended to inform strategic planning and competitive positioning for Aurora Creative leadership.
Trend: Senior-led boutique agencies gaining ground. Mid-sized agencies with senior involvement are increasingly favored over large holding-company agencies for high-stakes brand and reputation work. Key players: Rina Kaur (Aurora Creative); Elaine Porter (Northline Collective); James Holloway (Signal & Form).
Trend: Vertical specialization in regulated industries. Healthcare, fintech, and energy clients increasingly favor agencies with narrow vertical focus and embedded compliance expertise. Key firms: CarePoint Marketing Group (healthcare); Ledger & Loop (fintech); Public Axis (energy and public affairs).
Trend: Performance marketing saturation and rising costs. Paid media costs continue to rise across search and social, pushing agencies toward hybrid brand + performance strategies and retention-focused work. Key voices: Jae Min (Aurora Creative); Dana Schultz (Growthcraft); Devon Hart (LoopSound, client-side).
Trend: Content modularity and rapid iteration. Campaigns increasingly rely on modular creative systems that allow fast testing and localized adaptation. Key practitioners: Theo Grant (Aurora Creative); Mira Das (Aurora Creative); Rachel Kim (VistaTrail).
Trend: Increased executive and reputational risk management. Corporate reputation, crisis preparedness, and narrative control have become core agency offerings. Key firms: Aurora Creative; Public Axis; Meridian Advisory. Key professionals: Marcus Yen (Aurora Creative); Anya Volkov (HelioGrid Energy); Max Feld (Aurora Creative).
